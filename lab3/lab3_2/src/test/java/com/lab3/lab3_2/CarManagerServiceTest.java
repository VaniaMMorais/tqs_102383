...
public class CarManagerServiceTest {
    ...
    public void setUp() {
        ...
        Mockito.when(carRepository.findByCarId(c1.getCarId())).thenReturn(Optional.of(c1));
        Mockito.when(carRepository.findByCarId(c3.getCarId())).thenReturn(Optional.of(c3));
